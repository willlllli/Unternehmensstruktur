...
public class SingleMitarbeiterView extends SimpleSingleView<MitarbeiterDto> {
    ...
    protected void addFields() {
        addField("Personalnummer",         () -> dto.getPersonalnummer(),           value -> {},                                             FieldType.INTEGER);
        ...
        addField("Geburtsdatum",           () -> dto.getGeburtsdatum(),             value -> dto.setGeburtsdatum(toDate(value)),            FieldType.DATE);
