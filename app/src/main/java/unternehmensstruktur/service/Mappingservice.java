...
public class Mappingservice<I extends BaseEntity, D extends BaseDto> {
    ...
    public Mitarbeiter map(MitarbeiterDto dto) {
        ...
        if (dto.getPrivatadresseId() != null)
            m.setPrivatadresse(adresseRepository.findById(dto.getPrivatadresseId())
                .orElseThrow(() -> new IllegalArgumentException("Adresse mit ID " + dto.getPrivatadresseId() + " existiert nicht")));
    ...
    public Standort map(StandortDto dto) {
        ...
        if (dto.getAdresseId() != null)
            s.setAdresse(adresseRepository.findById(dto.getAdresseId())
                .orElseThrow(() -> new IllegalArgumentException("Adresse mit ID " + dto.getAdresseId() + " existiert nicht")));
    ...
    public Filiale map(FilialeDto dto) {
        ...
        if (dto.getAdresseId() != null)
            t.setAdresse(adresseRepository.findById(dto.getAdresseId())
                .orElseThrow(() -> new IllegalArgumentException("Adresse mit ID " + dto.getAdresseId() + " existiert nicht")));
    ...
    public Buerogebaeude map(BuerogebaeudeDto dto) {
        ...
        if (dto.getAdresseId() != null)
            b.setAdresse(adresseRepository.findById(dto.getAdresseId())
                .orElseThrow(() -> new IllegalArgumentException("Adresse mit ID " + dto.getAdresseId() + " existiert nicht")));
    ...
    public Organisationseinheit map(OrganisationseinheitDto dto) {
        ...
        if (dto.getStandortId() != null)
            o.setStandort(standortRepository.findById(dto.getStandortId())
                .orElseThrow(() -> new IllegalArgumentException("Standort mit ID " + dto.getStandortId() + " existiert nicht")));
        if (dto.getUebergeordneteOeId() != null)
            o.setUebergeordneteOe(organisationseinheitRepository.findById(dto.getUebergeordneteOeId())
                .orElseThrow(() -> new IllegalArgumentException("Organisationseinheit mit ID " + dto.getUebergeordneteOeId() + " existiert nicht")));
        if (dto.getLeiterId() != null)
            o.setLeiter(mitarbeiterRepository.findById(dto.getLeiterId())
                .orElseThrow(() -> new IllegalArgumentException("Mitarbeiter mit ID " + dto.getLeiterId() + " existiert nicht")));
        return o;
    }
    ...
    public Mitglied map(MitgliedDto dto) {
        ...
        if (dto.getMitarbeiterId() != null)
            m.setMitarbeiter(mitarbeiterRepository.findById(dto.getMitarbeiterId())
                .orElseThrow(() -> new IllegalArgumentException("Mitarbeiter mit ID " + dto.getMitarbeiterId() + " existiert nicht")));
        if (dto.getOrganisationseinheitId() != null)
            m.setOrganisationseinheit(organisationseinheitRepository.findById(dto.getOrganisationseinheitId())
                .orElseThrow(() -> new IllegalArgumentException("Organisationseinheit mit ID " + dto.getOrganisationseinheitId() + " existiert nicht")));
        return m;
    }
    ...
    public Kunde map(KundeDto dto) {
        ...
        if (dto.getAdresseId() != null)
            k.setAdresse(adresseRepository.findById(dto.getAdresseId())
                .orElseThrow(() -> new IllegalArgumentException("Adresse mit ID " + dto.getAdresseId() + " existiert nicht")));
    ...
    public ItAsset map(ItAssetDto dto) {
        ...
        if (dto.getOrganisationseinheitId() != null)
            a.setOrganisationseinheit(organisationseinheitRepository.findById(dto.getOrganisationseinheitId())
                .orElseThrow(() -> new IllegalArgumentException("Organisationseinheit mit ID " + dto.getOrganisationseinheitId() + " existiert nicht")));
        if (dto.getKundeId() != null)
            a.setKunde(kundeRepository.findById(dto.getKundeId())
                .orElseThrow(() -> new IllegalArgumentException("Kunde mit ID " + dto.getKundeId() + " existiert nicht")));
        return a;
    }
    ...
    public Abhaengigkeit map(AbhaengigkeitDto dto) {
        ...
        if (dto.getUpstreamItAsset() != null)
            a.setUpstreamItAsset(itAssetRepository.findById(dto.getUpstreamItAsset())
                .orElseThrow(() -> new IllegalArgumentException("IT-Asset mit ICTO-Nummer " + dto.getUpstreamItAsset() + " existiert nicht")));
        if (dto.getDownstreamItAsset() != null)
            a.setDownstreamItAsset(itAssetRepository.findById(dto.getDownstreamItAsset())
                .orElseThrow(() -> new IllegalArgumentException("IT-Asset mit ICTO-Nummer " + dto.getDownstreamItAsset() + " existiert nicht")));
        return a;
    }
    ...
    public ItSystem map(ItSystemDto dto) {
        ...
        if (dto.getOrganisationseinheitId() != null)
            s.setOrganisationseinheit(organisationseinheitRepository.findById(dto.getOrganisationseinheitId())
                .orElseThrow(() -> new IllegalArgumentException("Organisationseinheit mit ID " + dto.getOrganisationseinheitId() + " existiert nicht")));
        if (dto.getKundeId() != null)
            s.setKunde(kundeRepository.findById(dto.getKundeId())
                .orElseThrow(() -> new IllegalArgumentException("Kunde mit ID " + dto.getKundeId() + " existiert nicht")));
    ...
    public Projekt map(ProjektDto dto) {
        ...
        if (dto.getOrganisationseinheitId() != null)
            p.setOrganisationseinheit(organisationseinheitRepository.findById(dto.getOrganisationseinheitId())
                .orElseThrow(() -> new IllegalArgumentException("Organisationseinheit mit ID " + dto.getOrganisationseinheitId() + " existiert nicht")));
        if (dto.getKundeId() != null)
            p.setKunde(kundeRepository.findById(dto.getKundeId())
                .orElseThrow(() -> new IllegalArgumentException("Kunde mit ID " + dto.getKundeId() + " existiert nicht")));
    ...
    public Arbeitsplatz map(ArbeitsplatzDto dto) {
        ...
        if (dto.getStandortId() != null)
            a.setBuerogebaeude(buerogebaeudeRepository.findById(dto.getStandortId())
                .orElseThrow(() -> new IllegalArgumentException("Bürogebäude mit ID " + dto.getStandortId() + " existiert nicht")));
    ...
    public Schreibtisch map(SchreibtischDto dto) {
        ...
        if (dto.getStandortId() != null)
            s.setBuerogebaeude(buerogebaeudeRepository.findById(dto.getStandortId())
                .orElseThrow(() -> new IllegalArgumentException("Bürogebäude mit ID " + dto.getStandortId() + " existiert nicht")));
    ...
    public Meetingraum map(MeetingraumDto dto) {
        ...
        if (dto.getStandortId() != null)
            m.setBuerogebaeude(buerogebaeudeRepository.findById(dto.getStandortId())
                .orElseThrow(() -> new IllegalArgumentException("Bürogebäude mit ID " + dto.getStandortId() + " existiert nicht")));
    ...
    public Buchung map(BuchungDto dto) {
        ...
        if (dto.getStandortId() != null)
            b.setBuerogebaeude(buerogebaeudeRepository.findById(dto.getStandortId())
                .orElseThrow(() -> new IllegalArgumentException("Bürogebäude mit ID " + dto.getStandortId() + " existiert nicht")));
        if (dto.getMitarbeiterId() != null)
            b.setMitarbeiter(mitarbeiterRepository.findById(dto.getMitarbeiterId())
                .orElseThrow(() -> new IllegalArgumentException("Mitarbeiter mit ID " + dto.getMitarbeiterId() + " existiert nicht")));
        return b;
    }
}
